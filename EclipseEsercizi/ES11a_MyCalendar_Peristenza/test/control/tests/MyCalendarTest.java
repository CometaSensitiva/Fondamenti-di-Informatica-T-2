...
public class MyCalendarTest {
	...
	public void testRemove() {
		...
		boolean removed = myCal.removeWithoutSaving(app3);
		assertTrue(removed);
	...
	public void testGetListAppointmentMonth() {
		...
		LocalDateTime to1 = LocalDateTime.of(2012, Month.MARCH, 31, 15, 30, 0);
		Appointment app1 = new Appointment("Compleanno", from1, to1);
		myCal.addWithoutSaving(app1);
