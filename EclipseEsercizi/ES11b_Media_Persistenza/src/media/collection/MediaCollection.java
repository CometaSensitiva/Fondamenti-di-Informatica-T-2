...
public class MediaCollection {
	...
	public MediaCollection sorted(Comparator<Media> cmp) {
		Media[] result = null;
		result = Arrays.copyOf(innerContainer, innerContainer.length);
		Arrays.sort(result, cmp);
		return new MediaCollection(result);

	}

	public void sortWith(Comparator<Media> cmp) {
		Arrays.sort(innerContainer);
	}
