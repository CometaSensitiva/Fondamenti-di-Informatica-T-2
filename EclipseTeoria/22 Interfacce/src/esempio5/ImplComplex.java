...
public class ImplComplex implements Complex {
	...
	/**
	 * Constructs a new complex number with the specified real part and zero
	 * imaginary part.
	 * 
	 * @param realPart the real part of the complex number
	 */
	public ImplComplex(double realPart) {
		setRealPart(realPart);
		setImPart(0);
	}

	/**
	 * Constructs a new complex number with zero real and imaginary parts.
	 */
	public ImplComplex() {
		setRealPart(0);
		setImPart(0);
