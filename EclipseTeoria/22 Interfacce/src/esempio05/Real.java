...
/**
 * 
 * The Real interface represents a real number and provides arithmetic
...
public interface Real extends Complex {
	...
	/**
	 * Creates a new Real instance with value of 0.
	 *
	 * @return a new Real instance with value of 0.
	 */
