...
import fractioncollection.*;

import frazione.*;

/**
 * This class contains tests for the FractionCollection class.
 * 
...
public class FractionCollectionTests {
	...
	public static void main(String[] args) {
		...
		c4.put(new Frazione(3, 2));

		FractionCollection resFail = c3.sum(c4);

		assert ((resFail == null) == true);
