...
/**
 * This class contains tests for the Frazione class.
 * 
...
public class MainFrazione {
	...
	public static void main(String[] args) {
		...
		if (frazione1.equals(frazione2)) // true
			System.out.println(
					"Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione2) + " sono equivalenti");
		else
			System.out.println(
					"Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione2) + " non sono equivalenti");

		assert (!frazione1.equals(frazione3));
		if (frazione1.equals(frazione3)) // false
			System.out.println(
					"Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione3) + " sono equivalenti");
		else
			System.out.println(
					"Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione3) + " non sono equivalenti");

		assert (!frazione1.equals(frazione6));
		if (frazione1.equals(frazione6)) // false
			System.out.println(
					"Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione6) + " sono equivalenti");
		else
			System.out.println("Le frazioni " + getAsString(frazione1) + " e " + getAsString(frazione6)
		...
		System.out.println("La frazione " + getAsString(frazione1) + " ridotta ai minimi termini diventa "
				+ getAsString(frazioneRid) + "\n"); // 1/4

		frazioneRid = frazione6.minTerm();
		assert (frazioneRid.getNum() == -2 && frazioneRid.getDen() == 3);
		System.out.println("La frazione " + getAsString(frazione6) + " ridotta ai minimi termini diventa "
				+ getAsString(frazioneRid) + "\n"); // -2/3
