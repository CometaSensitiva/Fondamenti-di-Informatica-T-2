...
public class LineaPaPTest {
	...
	@BeforeEach
	void setup() {
		mappa22 = Map.of(0, new Fermata("40", "Porta San Mamolo"), 3, new Fermata("42", "Aldini"), 5,
				new Fermata("44", "Porta Saragozza - Villa Cassarini"));
		mappa23 = Map.of(0, new Fermata("47", "Porta Saragozza - Villa Cassarini"), 2, new Fermata("49", "Aldini"), 3,
				new Fermata("45", "Petrarca"), 5, new Fermata("43", "Porta San Mamolo"));
